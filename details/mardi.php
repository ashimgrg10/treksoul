...
<body>
  ...
  <div class="trek-container">
    ...
    <img src="../image/mardi.jpg" alt="ABC Trek Image" class="trek-image" />

    <p>
      The Mardi Himal Trek is a popular trek in Nepal's Annapurna region, known for its stunning views, diverse landscapes,
      and moderate difficulty, making it suitable for both beginners and experienced trekkers. The trek typically ranges from 4 to 7 days,
      offering a mix of teahouse and camping experiences. Trekkers journey through lush rhododendron forests, past traditional Gurung 
      villages, and up to scenic ridges, culminating at Mardi Himal Base Camp (4,500m). 
    </p>
