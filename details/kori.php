...
<body>
  ...
  <div class="trek-container">
    <h1>Kapucche and Kori Trek</h1>
    <img src="../image/kori.jpg" alt="ABC Trek Image" class="trek-image" />

    <p>
      Kapuche Lake Kori Trek is a beautiful trip in central Nepal, a serene trail that has earned great fame recently. 
      The trek explores the hillside region between the Annapurna and Manaslu Himal ranges. As such, 
      the glorious Kapuche Lake and the trail to Kori Danda offer a unique trekking experience.
    </p>
    ...
    <div id="booking-form" class="booking-box">
      ...
      <form action="kori_plan.php" method="POST">
  ...
  <input type="number" id="days" name="days" min="1" max="3" required />

  <!-- 🔍 New Hotel Preference Field -->
  <label for="hotel_type">Preferred Hotel Type:</label>
